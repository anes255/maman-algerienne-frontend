...
import {
  ...
  FaPalette, FaPlus, FaEdit, FaTrash, FaCheck, FaTimes, FaChartLine
} from 'react-icons/fa';
...
const Admin = () => {
  ...
  const handleEdit = (item) => {
    ...
    const images = item.contentImages ? item.contentImages.map(img => {
      ...
      return img.startsWith('blob:') || img.startsWith('http') ? img : `http://localhost:5000${img}`;
    }) : [];
              ...
              <div className="ads-grid">
                {ads.map((ad) => (
                  <div key={ad._id} className="ad-card">
                    <img
                      src={ad.image.startsWith('http') ? ad.image : `http://localhost:5000${ad.image}`}
                      alt={ad.title}
                    />
            ...
            >
              ...
              >
                ...
                <div className="form-group">
                  ...
                  {currentItem?.image && (
                    <img
                      src={`http://localhost:5000${currentItem.image}`}
                      alt="Current"
